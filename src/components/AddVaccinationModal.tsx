// src/components/AddVaccinationModal.tsx
...
interface AddVaccinationModalProps {
  isVisible: boolean;
  onClose: () => void;
  onSubmit: (vaccination: VaccinationForm) => void;
}
...
const AddVaccinationModal: React.FC<AddVaccinationModalProps> = ({
  ...
  const methodes = [
    { label: 'Sélectionner une méthode', value: '' },
    { label: 'Eau de boisson', value: 'Eau de boisson' },
    { label: 'Injection', value: 'Injection' },
    { label: 'Aérosol', value: 'Aérosol' },
  ];
  ...
  const validateForm = () => {
    ...
    if (!form.methode) newErrors.methode = 'Méthode requise';
    setErrors(newErrors);
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          >
            ...
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Ajouter Vaccin/Traitement</Text>
            ...
            {/* Champ Type */}
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Type de vaccin/traitement *</Text>
              <CustomSelect
                options={types}
                value={form.type}
                onChange={(value) => {
            ...
            {/* Champ Méthode */}
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Méthode d’administration *</Text>
              <CustomSelect
                options={methodes}
                value={form.methode}
                onChange={(value) => {
                  setForm({ ...form, methode: value });
